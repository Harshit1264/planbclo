...
const adminOrderRoutes = require('./routes/adminOrders'); // Admin orders route
const customOrderRoutes = require('./routes/customOrder'); // Custom order route
...
app.get('/', optionalAuthenticateToken, (req, res) => {
  res.render('home', { token: req.cookies.token, user: req.user });
});
